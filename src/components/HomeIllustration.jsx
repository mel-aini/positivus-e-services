	...
	return (
		<div className='md:min-w-[50%] flex justify-end'>
			<div className="relative h-[230px] mb-[130px] mt-[50px] md:mr-[50px] lg:mr-[100px] lg:scale-125 2xl:scale-150">
				...
				<Ellipse className='absolute top-[50px] left-[-20px] w-[25px]' style={{ fill: colors.main }} />
				<Ellipse className={`absolute top-[238px] right-[40px] w-[15px] fill-black`} style={{ fill: colors.main }} />
