    ...
    return (
        <div className="w-[90%] mx-auto flex flex-col justify-center items-center my-5">
            ...
            <div className="w-full relative overflow-hidden lg:bg-gray-200 lg:rounded-[45px] lg:p-14">
                <form action="" className='lg:max-w-[50%]' onSubmit={(e) => e.preventDefault()}>
                    <div className="flex flex-col gap-5 rounded-[45px] bg-gray-200 py-10 px-7 lg:p-0">
                        <div className="flex gap-3 lg:justify-start justify-center">
                            <div className="flex justify-center items-center gap-2 ">
                                <input type="radio" name="choice" id="say-hi" />
                        ...
                        <div className="flex flex-col gap-1">
                            ...
                            <input type="text" name="name" id="name" placeholder='Name' className="border-[1px] border-solid border-black outline-none p-4 rounded-2xl"/>
                        </div>
                        <div className="flex flex-col gap-1">
                            <label htmlFor="email">Email*</label>
                            <input type="email" name="email" id="email" placeholder='Email' className="border-[1px] border-solid border-black outline-none p-4 rounded-2xl"/>
                        </div>
                        <div className="flex flex-col gap-1">
                    ...
                    <button type="submit" className="bg-black h-[60px] text-white rounded-2xl w-full my-6">Send Message</button>
                </form>
                <Illustration className="hidden lg:block absolute right-0 top-[50%] translate-y-[-50%] translate-x-[50%]" />
            </div>
        </div>
    )
}
