...
function Footer({ colors }) {
  return (
    <div
      className="w-[100%] font-light sm:w-[90%] mx-auto flex flex-col gap-10 lg:gap-16 justify-center items-center mt-10 text-white py-10 px-5 sm:rounded-[45px_45px_0_0] sm:mt-28"
    ...
    >
      ...
      <div className="w-full lg:w-[90%] lg:h-[190px] flex flex-col items-center gap-8 lg:gap-0 lg:flex-row lg:justify-between">
        <div className="flex flex-col items-center gap-4 max-w-[270px] lg:items-start">
          <h1
            className="font-bold rounded-lg px-2 py-[1px] mb-5"
