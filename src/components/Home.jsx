...
function Home( {mainColor} ) {
	...
	return (
		<div className='py-[20px] flex flex-col justify-center items-center'>
			<div className="w-[90%] mx-auto flex justify-center xl:justify-between items-center lg:h-[80vh]">
				<div className='py-[20px] flex flex-col justify-center xl:items-start items-center xl:w-[50%] md:max-xl:text-center'>
					<p className="text-4xl 2xl:lg:leading-[2.5] lg:text-5xl 2xl:text-7xl font-medium leading-normal lg:leading-[1.3] lg:mb-10">Navigating the digital landscape for success</p>
